    ...
    <div className="search w-100 position-relative me-4"  >
      ...
      <nav>
        <div className="nav nav-pills nav-fill mt-2 mb-1" id="search-tab" role="tablist">
          <button className="nav-link active" id="search-all-tab" data-bs-toggle="tab" data-bs-target="#search-all" type="button" role="tab" aria-controls="search-all" aria-selected="true">All</button>
          <button className="nav-link" id="search-blog-tab" data-bs-toggle="tab" data-bs-target="#search-blog" type="button" role="tab" aria-controls="seacrh-blog" aria-selected="false">Blogs</button>
      ...
      <>
        <div className="tab-content my-3 position-relative pt-2 px-1 w-100 rounded mt-2" id="nav-tabContent"
          ...
          <div className="tab-pane fade show active" id="search-all" role="tabpanel" aria-labelledby="search-all-tab" tabIndex={0}>
              ...
              <div className="row">
                <div className="col-sm-6 my-2">
...

                  {
                    users?.length
                      ?
                      <div className={`m-2 rounded bg-light p-2 bg-${isdarkMode?'dark':'light'}`}>
          ...
          <div className="tab-pane fade" id="search-blog" role="tabpanel" aria-labelledby="search-blog-tab" tabIndex={0}>
            {
              blogs && blogs?.length
                ?
                blogs.map(blog => (
