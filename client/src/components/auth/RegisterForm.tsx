...
const RegisterForm = () => {
  ...
  return (
    <>
      {variable === "ref" && refered && (
        <div className="alert alert-success pb-1">
          <p>You have been refered by : </p>
          <div className="d-flex flex-row justify-content-between align-items-center">
            <Link
              to={`/profile/${refered?._id}`}
            ...
            >
              <div className="d-flex flex-row align-items-center">
                ...
                <div className="d-flex flex-column align-items-start ml-2">
                  ...
                  <span className="followers text-dark">
                    {refered?.follower.length} Followers
                  </span>
                </div>
              </div>
              <hr />
          ...
          <p>
            <small>
              If not correct tell the friend to send the correct link.
            </small>
          </p>
        </div>
      )}
